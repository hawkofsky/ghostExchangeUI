...
const DisclaimerModal: React.FC<DisclaimerModal> = ({
  ...
  const modalContent = useMemo(() => {
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p>
            ...
            interface for all interactions with the GhostSwap protocol.
          </p>
          <p>
            {' '}
            Development will be on going, and ghostswapclassic will still exist
      ...
      return (
        <div>
          <StyledLink target="_blank" href="https://ghostswap.fi">
