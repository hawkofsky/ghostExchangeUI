...
export class Ghost {
  constructor(provider, networkId, testing, options) {
    ...
    this.ghostAddress = contractAddresses.ghost[networkId]
    this.kingGhostAddress = contractAddresses.kingGhost[networkId]
    this.wbnbAddress = contractAddresses.wbnb[networkId]
    this.busdAddress = contractAddresses.busd[networkId]
  }
