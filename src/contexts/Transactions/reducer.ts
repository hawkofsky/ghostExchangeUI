...
type TransactionsActions = SetStatsDataAction | AddTransactionAction | ReceiveTxReceiptAction | SetTransactionsAction
...
export const setStatsData = (statsData: Array<object>): SetStatsDataAction =>({
  type: SET_STATS_DATA,
  statsData
})
